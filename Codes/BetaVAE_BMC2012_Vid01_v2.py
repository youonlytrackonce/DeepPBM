...
vidNumber = 1
nSample = 520  # number of samples to be loaded for the training
loadPath = '../Data/Video_%03d/frames_up/' % vidNumber
...
#Path parameters
save_PATH = './Result/BMC2012/Video_%03d' % vidNumber + '_h_layer_5_{}_batch_size_{}_epoch_num_{}'.format(h_layer_5, batch_size, epoch_num)
